...
function clearAll() {
  ...
  const ridd = document.querySelector('.riddle-content');
  const wisd = document.querySelector('.wisdom-content');
    meme.innerHTML = '';
    joke.innerHTML = '';
    ridd.innerHTML = '';
    wisd.innerHTML = '';
...
function showRiddle() {
  ...
  a.setAttribute('id','riddle-answer');
  a.hidden = true;
  clearAll();
...
function revealAnswers() {
  ...
  if(riddle && answer.hidden){
    ...
    alert('Answer is already revelaed');
  }
  else
